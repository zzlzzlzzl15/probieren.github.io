...
# ╔═╡ 90210670-ac2b-4ab1-a319-292fc1d06abd
begin
...
function plot_show(line_1, line_2, line1_label, line2_label)
...
begin
	...
	plot_show(A_obs, B_obs, signal1_label, signal2_label)
	
end

# ╔═╡ dfc5ef72-0c3e-4099-b7b8-f594f5414df1
begin
	plot_show(A, B, signal1_label, signal2_label)
end
...
begin
	...
	plot_show(line1, line2, "$a $signal1_label+ $b $signal2_label", "$c $signal1_label+ $d $signal2_label")
end
...
$$A = \left[
		\begin{matrix}
			...
			\quad sin\theta \quad \quad cos\theta \quad
	  	\end{matrix}
	\right]
...
begin
	plot_show(rotated_signal[1,:], rotated_signal[2,:], "Rotated signal 1", "Rotated signal 2")
>>>>>>> c5fabc8de963e2436a37bf81bf89009c1a90d709
end
...
# ╠═a31bef66-e441-4389-b4db-a86ba6d01c79
# ╠═24f27037-3c99-45ec-b22e-d2f4cfdce411
>>>>>>> 777afc56e602a7cb321fc46c0587b5dc4ffb18d1
# ╟─26f37ed7-ac54-4dc2-9e7a-b09afd4a51c9
# ╟─3e4639ca-2a42-48af-955a-973d1e3d8483
# ╟─b6acb9e8-5f9d-47af-948b-244c3c90ab42
# ╟─0bc39b2a-397e-48d5-bb6c-f489334f666c
