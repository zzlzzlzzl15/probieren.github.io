...
# ╔═╡ 7d2a43f4-aa2c-4ad6-b54f-ac1f9f42f9b0
using SampledSignals


# ╔═╡ f8e3f270-efff-11ec-0d9c-c77925860aaa
begin
	using DSP, WAV, ImageIO# "using" makes the listed modules available for 
	using PlutoUI
	using CairoMakie
...
# ╔═╡ 26d7621b-ebff-4ff6-b87e-3e3800030dbd
# ╠═╡ disabled = true
#=╠═╡
Pkg.build("PyCall")
  ╠═╡ =#

# ╔═╡ 8292e052-83a1-4ff6-a2a2-bf27a4231113
size(s)

# ╔═╡ a82a9b27-286b-490a-9148-1b0f7931189b
begin
	#fs1 = 8000
	
end

# ╔═╡ e3c144ae-759f-435f-9ada-993d9c21ce6c
begin
	typeof(fs)
end

# ╔═╡ 207426c1-68e2-411f-b1e5-09272769408f
data = s[1:80000]

# ╔═╡ c970d810-a61b-4175-8fcc-0675e3068421
begin
	f = Figure()
	g1 = f[1, 1] = Axis(f)

	scatter!(g1, range(0.,length=length(data),step=1/fs), data)
...
# ╔═╡ adf6555c-0149-4f5d-940d-6e964fda514b
md"""
The first audio signal
"""

# ╔═╡ 27564441-fe4e-440a-b7bb-fff8378120e7
begin
	SampledSignals.SampleBuf(data, fs)
	
end

# ╔═╡ 4751bcd6-b1a4-40a9-bd42-dd43d5e284db
typeof(s)

# ╔═╡ d2368ae0-a69a-43d8-a4a9-0fd5572d6869


# ╔═╡ 8c95eb95-ee0b-45c8-aa81-0f25bd0d0107
# ╠═╡ disabled = true
#=╠═╡
Pkg.build("PyCall")
  ╠═╡ =#

# ╔═╡ 27252016-296b-4c7c-9693-c964aaeb2e30
s2, fs2 = wavread("taylor_enchanted_10sec.wav")

# ╔═╡ baee5815-d78d-47bb-8a76-8117d6f106d3
data2 = s2[1:80000]

# ╔═╡ 6e7ab9fe-0215-42f3-a593-cd0f39f23345
size(s2)

# ╔═╡ eb84909e-75e9-4901-a31d-d3402299f4eb
begin
	typeof(fs)
end

# ╔═╡ 9dcb3511-73bf-4d48-87b5-0ec303f56fbc
begin
	SampledSignals.SampleBuf(data2, fs2)
	
end

# ╔═╡ b88d1dde-8f1f-48f2-90e7-929fb61b3ca8
