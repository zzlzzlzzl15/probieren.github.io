...
# ╔═╡ fcce28a7-d615-4cb4-b61d-e1699ebb4cf9
begin
	using CairoMakie
	point_number = 500
	...
	A = sin.(xs)
	B = cos.(3xs)
	scatter(xs, A, color = :red, markersize = 5)
	scatter!(xs, B, color = :blue, markersize = 10)
	current_figure()
end

# ╔═╡ dd564bae-df1a-44b4-a38c-8cd266a626e4
using MultivariateStats

# ╔═╡ 1c054f28-e93e-4aca-afa0-a72b0054e700
using StatsBase
...
# ╔═╡ 9df004a6-f900-4984-989b-93487e1d21d0
md"""
Original signal
"""

# ╔═╡ 1107c8e9-b1a2-4b1a-b1f2-dc61a79cef40
begin
	f1 = Figure()
	ax1 = Axis(f1[1, 1])

	sc1 = scatter!(A, B, color = :red, label = "Red Dots")
	axislegend()
	current_figure()
end

# ╔═╡ 7ee8cb45-ca1d-472f-aa79-53ce8455fb07
md"""
Mixed signal
"""

# ╔═╡ 8bdc1c72-8c15-4332-bcfc-71a2caa5b3e8
begin
	line1 = 1*A - 2*B
	line2 = 1.73*A +3.41*B

	scatter(xs, line1, color = :red, markersize = 5)
	scatter!(xs, line2, color = :blue, markersize = 10)
	current_figure()
end

# ╔═╡ a5b61db7-b64e-40a6-9118-4bcd52a24558
begin
	f2 = Figure()
	ax2 = Axis(f2[1, 1])

	sc2 = scatter!(line1, line2, color = :red, label = "Red Dots")
	axislegend()
	current_figure()
end

# ╔═╡ 64ecf9e9-35a8-4360-887f-4ceff7796a40
md"""
calculate the demeaning data
"""

# ╔═╡ 8a3612e8-05ff-4a7a-a06e-8bfedf062040
begin
	mean1 = mean(line1)
	mean2 = mean(line2)
...
# ╔═╡ 30cd2ba2-3598-4a4b-9565-e91821883196
begin
...
# ╔═╡ c017c72c-439c-47c7-a473-497db139cd20
demeaning_matrix

# ╔═╡ 9ac5f3c0-9169-4406-b2be-4220768b1214
M

# ╔═╡ 315a6297-706d-4485-a44c-4bb229bfb4dd
M.W

# ╔═╡ a13de6e6-c82d-4e5d-9e3f-87e6c77d0090
begin
	whitening_matrix = transpose(M.W) * demeaning_matrix
end

# ╔═╡ d5a5d22c-5bc8-4ae9-8009-80cbd26eca65
begin

	scatter(xs, whitening_matrix[1,:], color = :red, markersize = 5)
	scatter!(xs, whitening_matrix[2,:], color = :blue, markersize = 10)
	current_figure()
end

# ╔═╡ 05e2eac6-7ff7-42a6-b30f-ff326af724a5
begin
...
# ╔═╡ 13f9ca3d-910f-4018-a2c4-84b5996659b5
begin
	f3 = Figure()
	ax3 = Axis(f3[1, 1])
	

	sc3 = scatter!(x1, x2, color = :red, label = "Red Dots")
	axislegend()
	current_figure()
end

# ╔═╡ ee5720d1-4454-4aad-aa38-d2716a531a27
md"""
Rotation(FastICA)
"""
...
# ╔═╡ a46b939a-7eec-4275-9e32-b1e4f8bfe3d8
unmixing_W.W
...
begin
	...
	scatter(xs, unmixed_line1, color = :red, markersize = 5)
	scatter!(xs, unmixed_line2, color = :blue, markersize = 10)
	current_figure()
end
