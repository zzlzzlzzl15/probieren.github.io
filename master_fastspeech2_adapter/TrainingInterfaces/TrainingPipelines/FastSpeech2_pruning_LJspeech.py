...
from TrainingInterfaces.Text_to_Spectrogram.FastSpeech2.fastspeech2_pruning_train_loop import train_loop
...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "FastSpeech2_BitFit")  # KEEP THE 'FastSpeech2_' BUT CHANGE THE MODEL ID TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    train_loop(net=model,
               ...
               path_to_checkpoint=os.path.join(MODELS_DIR, "FastSpeech2_BitFit", "best.pt") if resume_checkpoint is None else resume_checkpoint,
