...
from Utility.path_to_transcript_dicts import build_path_to_transcript_dict_vctk_p254_200data
...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "FastSpeech2_BitFit_vctk_p254_200data")  # KEEP THE 'FastSpeech2_' BUT CHANGE THE MODEL ID TO SOMETHING MEANINGFUL FOR YOUR DATA
    os.makedirs(save_dir, exist_ok=True)

    datasets = list()
    datasets.append(prepare_fastspeech_corpus(transcript_dict=build_path_to_transcript_dict_vctk_p254_200data(),
                                              corpus_dir=os.path.join(PREPROCESSING_DIR, "vctk_p254_200data"),
    ...
    """Turns off the model parameters requires_grad except the trainable_components.
            ...
            from: https://arxiv.org/pdf/2106.10199.pdf
    ...
    for name,param in model.named_parameters():
        ...
        print(split_name[-1])
        if split_name[-1] == 'weight': #or split_name[-1].split('_')[1] == 'bias':
    ...
    train_loop(net=model,
               ...
               path_to_checkpoint=os.path.join(MODELS_DIR, "FastSpeech2_libri_all_clean_2", "best.pt") if resume_checkpoint is None else resume_checkpoint,
