    ...
    def _add_diff_parametrizations(self, *args) -> None:
        ...
        for base_module in self.get_encoder_base_modules():
            for n, p in list(base_module.named_parameters()):
                print('embed.0.weight: ', base_module.state_dict()['embed.0.weight'].shape)
                parametrize.register_parametrization(base_module, n, DiffWeight(p, *args),unsafe = False)
                #DiffWeight(base_module, n, p, *args)
